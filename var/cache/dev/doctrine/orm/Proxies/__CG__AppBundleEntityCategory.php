...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'priority', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'products', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'children', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'parent', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'brands'];
        }
